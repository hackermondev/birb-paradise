...
// const hastebin = require('hastebin'); // removed because hastebin not imported
const { MessageEmbed } = require('discord.js');

module.exports = {
	name: 'eval',
	aliases: ['ev','e','execute'],
	description: 'Evaluates code',
	permissions: 'client.application.owner',
	
	async execute(client, message, args) {
		if (!client.application.owner) await client.application.fetch();
		if ((message.author != client.application.owner) && (message.author.id != '671780654882619393')) return message.delete();
		let code = args.join(' ');
